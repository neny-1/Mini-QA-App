...
class DataChunks(BaseModel):
    ...
    chunk_metadata:dict  # metadata of the chunk 
    chunk_order:int=Field(...,gr=0) # order of the chunk in the document 
    chunk_project_id:ObjectId # id of the project that the chunk belongs to
